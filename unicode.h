static const uint16_t uni2gbk[] = { /* Unicode --> GBK pairs */
...
static const uint16_t gbk2uni[] = { /* GBK --> Unicode pairs */
...
uint16_t uni2oem ( uint32_t uni)
{
	const uint16_t *p;
	uint16_t c = 0, uc;
	uint16_t i = 0, n, li, hi;
